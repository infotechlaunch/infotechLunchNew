        ...
        <div className="lg:py-16 py-10 bg-[#F3F4F6]">
            <div className="mx-auto 2xl:w-10/12 xl:w-5/6 w-11/12">
                <div className="text-center mb-10">
                    <h2 className="xl:text-4xl text-3xl text-[#212121] font-bold">Our Artificial Intelligence Success Stories</h2>
                    <p className="text-base font-normal mt-2">At 
                ...
                <div className="space-y-10">
                        ...
                        <div className="grid lg:grid-cols-2 grid-cols-1 gap-12">
                            ...
                            <div className="flex items-center">
                                <div className="space-y-4">
                                    <h3 className="xl:text-4xl md:text-2xl text-xl font-semibold">AI-Powered Retail Solutions</h3>
                                    <p className="xl:text-xl text-lg font-medium">Boosting Sales with AI-Powered Recommendations</p>
                                    ...
                                    <div>
                                        ...
                                        <div className="flex space-x-4 mt-3">
                                            ...
                                            <img alt="Tech Icon" loading="lazy" width="55"
                    ...
                    <div className="rounded-[40px] bg-[#fff] border border-[#000000]/10 space-x-3 px-8 md:py-10 py-6">
                        <div className="grid lg:grid-cols-2 grid-cols-1 gap-12">
                            ...
                            <div className="flex items-center">
                                <div className="space-y-4">
                                    <h3 className="xl:text-4xl md:text-2xl text-xl font-semibold">AI-Powered Healthcare Solutions</h3>
                                    <p className="text-black py-3">We developed an AI-driven system utilizing computer vision and machine learning to enhance diagnostic accuracy and speed. This AI software development solution enabled the healthcare provider to deliver faster, more precise diagnoses, improving patient outcomes and operational efficiency.</p>
                                    <div>
                    ...
                    <div className="rounded-[40px] bg-[#fff] border border-[#000000]/10 space-x-3 px-8 md:py-10 py-6">
                        <div className="grid lg:grid-cols-2 grid-cols-1 gap-12">
                            ...
                            <div className="flex items-center">
                                <div className="space-y-4">
                                    <h3 className="xl:text-4xl md:text-2xl text-xl font-semibold">AI-Powered Finance Solutions</h3>
                                    <p className="text-black py-3">A financial institution struggled with rising fraud incidents and required a robust solution. We developed a real-time fraud detection system using machine learning, enabling proactive identification and preventing fraudulent transactions, ensuring enhanced security and trust.</p>
                                    <div>
                                        <p className="text-black py-3"></p>
                                        <ul className="list-disc list-inside space-y-2"></ul>
                                    </div>
