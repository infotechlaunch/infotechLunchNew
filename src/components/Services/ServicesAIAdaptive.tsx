...
const challengeData = [
    {
        id: "card01",
        img: Services01,
        title: "Consulting & Strategic Planning",
        desc: "Our AI consulting specialists analyze your business needs and craft a tailored AI strategy designed to drive growth and overcome critical challenges.",
        icon: (
    ...
    },
    {
        id: "card02",
        img: Services02,
        title: "Tailored Adaptive AI Model Development",
        desc: "We design bespoke adaptive AI models that evolve and enhance over time, providing real-time value and a dynamic experience for your users.",
        icon: (
    ...
    },
    {
        id: "card03",
        img: Services03,
        title: "AI Model Integration and Deployment",
        desc: "Effortlessly incorporate adaptive AI models into your current applications, enabling personalized experiences and streamlined, automated workflows.",
        icon: (
    ...
    },
    {
        ...
        desc: "Our specialists manage data collection, processing, and security to provide high-quality data that powers your adaptive AI solutions.",
        icon: (
    ...
    },
    {
        ...
        desc: "Maintain peak performance and ensure your AI solution stays current with continuous support and regular feature enhancements.",
        icon: (
            <span className="text-white fs-4 icon-Digital-Infrastructure-Scalability2"></span>
        )
    }
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div className="chalnges-left">
                            <div className="sticky top-32 text-white">
                                ...
                                Accelerate Your Business Growth with Our Adaptive AI Solutions
                                <br />
                                <span className="text-base md:text-xl font-medium">
                                Our adaptive AI services enable continuous learning and innovation, driving rapid and sustainable business advancement. Explore how we can empower your success!
