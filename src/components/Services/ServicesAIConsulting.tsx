...
const challengeData = [
    {
        ...
        desc: "We analyze your operations, market trends, and data to find AI opportunities that align with your goals and drive results.",
        icon: (
    ...
    },
    {
        id: "card02",
        img: Services02,
        title: "Personalized AI Strategy Blueprint",
        desc: "We craft a customized AI roadmap with clear milestones and success metrics, fully aligned with your organization's goals and long-term vision.",
        icon: (
    ...
    },
    {
        id: "card03",
        img: Services03,
        title: "Smart AI Integration Strategy",
        desc: "We build a comprehensive plan for embedding AI into your existing ecosystem, ensuring a smooth transition and unlocking peak operational efficiency.",
        icon: (
    ...
    },
    {
        ...
        desc: "We examine your data quality and architecture to create a robust platform that supports and accelerates your AI initiatives.",
        icon: (
    ...
    },
    {
        id: "card05",
        img: Services05,
        title: "Industry-Focused Feasibility Studies",
        desc: "We perform detailed feasibility studies specific to your industry, tackling unique challenges to help you gain a competitive edge.",
        icon: (
            <span className="text-white fs-4 icon-Digital-Infrastructure-Scalability2"></span>
        )
    },
    {
        ...
        desc: "We create robust AI governance structures and perform thorough risk assessments to ensure secure, ethical, and compliant AI implementation",
        icon: (
            <span className="text-white fs-4 icon-Digital-Infrastructure-Scalability2"></span>
        )
    }
