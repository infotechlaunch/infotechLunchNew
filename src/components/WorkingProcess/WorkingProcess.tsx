    ...
    return (
        ...
        <div className="mx-auto 2xl:w-10/12 xl:w-5/6 w-11/12">
            <div className="text-center">
                ...
                <p className="text-lg mt-2"  data-aos="fade-up">Our mobile and web app development process is designed to deliver tailored solutions, ensuring seamless delivery and alignment with your business objectives.</p>
            </div>
            <div className="mt-10">
                <div className="styles_processContent__LoFa5">
                                ...
                                <g id="shape_1" transform="translate(-0.5 -0.5)">
                                    <g id="line">
                                        <path id="line8"
                                            ...
                                            transform="translate(0 -54)" fill="none" stroke="#f13c3c" stroke-miterlimit="10"
                                            stroke-width="2"></path>
                                        <path id="line7"
                                            ...
                                            transform="translate(0 -81)" fill="none" stroke="#f13c3c" stroke-miterlimit="10"
                                            stroke-width="2"></path>
                                        <path id="line6"
                                            ...
                                            transform="translate(0 -80)" fill="none" stroke="#212121" stroke-miterlimit="10"
                                            stroke-width="2"></path>
                                        <path id="line5"
                                            ...
                                            transform="translate(0 -41)" fill="none" stroke="#f13c3c" stroke-miterlimit="10"
                                            stroke-width="2"></path>
                                        <path id="line4"
                                        ...
                                        <path id="line3"
                                            ...
                                            fill="none" stroke="#f13c3c" stroke-miterlimit="10" stroke-width="2"></path>
                                        <path id="line2"
                                            ...
                                            fill="none" stroke="#212121" stroke-miterlimit="10" stroke-width="2"></path>
                                        <path id="line1"
                                    ...
                                    <g id="number" fill="#f13c3c">
                                        <path id="_7" d="M102.3,640.9l-5.4,15.2H93.4l5.4-14.3H92V639h10.3Z"
                    ...
                    <div className="styles_processStep__3cF6y space-y-2"  data-aos="fade-right" data-aos-delay="100">
                        ...
                        <p className="styles_processStepText__F8KN8">We align on goals, define milestones, and set timelines to ensure a clear and efficient project start.</p>
                    </div>
                    <div className="styles_processStep__3cF6y space-y-2" data-aos="fade-left" data-aos-delay="200">
                        ...
                        <p className="styles_processStepText__F8KN8">We craft user-friendly, visually engaging interfaces that balance creativity with seamless usability.</p>
                    </div>
                    <div className="styles_processStep__3cF6y space-y-2" data-aos="fade-right" data-aos-delay="250">
                        ...
                        <p className="styles_processStepText__F8KN8">We build interactive prototypes to test ideas early, refine usability, and reduce development risks.</p>
                    </div>
                    <div className="styles_processStep__3cF6y space-y-2" data-aos="fade-left" data-aos-delay="300">
                        ...
                        <p className="styles_processStepText__F8KN8">We use advanced tools to build robust backends and seamless frontends for optimal performance and user experience.</p>
                    </div>
                    <div className="styles_processStep__3cF6y space-y-2" data-aos="fade-right" data-aos-delay="350">
                        ...
                        <p className="styles_processStepText__F8KN8">We perform comprehensive testing to ensure your app is reliable, bug-free, and performs optimally.</p>
                    </div>
                    <div className="styles_processStep__3cF6y space-y-2" data-aos="fade-left" data-aos-delay="400">
                        ...
                        <p className="styles_processStepText__F8KN8">We deploy your app seamlessly, ensuring full compliance and smooth accessibility across platforms.</p>
                    </div>
                    <div className="styles_processStep__3cF6y space-y-2" data-aos="fade-up" data-aos-delay="450">
                        ...
                        <p className="styles_processStepText__F8KN8">We provide ongoing support to keep your app updated, optimized, and aligned with market trends.</p>
                    </div>
                </div>
            </div>
        </div>
