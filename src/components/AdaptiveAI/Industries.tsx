...
const Industries = [
    ...
    { title: "Autmotive", UrlLink: "#", img: finance },
    { title: "Logistics & Supply Chain", UrlLink: "#",  img: transportat },
    { title: "Education", UrlLink: "/education", img: education },
    { title: "Agriculture", UrlLink: "/E-Commerce", img: ecommerce },
    { title: "Real State", UrlLink: "/realstate", img: healthcare },
    { title: "Entertainment", UrlLink: "/entertainment",  img: entertainment },
    { title: "Travel & Hospitality", UrlLink: "#",  img: travel },
    { title: "Insurance", UrlLink: "/logistics", img: industrie },
    { title: "Fitness", UrlLink: "/fitness",  img: transportat },
            ...
            <div className="mx-auto 2xl:w-10/12 xl:w-5/6 w-11/12 bg-white md:py-14 py-8 md:px-10 px-6 rounded-3xl">
                <div className="flex items-center justify-between">
                    <div className="space-y-2">
                        <h2 className="xl:text-4xl text-3xl text-[#212121] font-bold"  data-aos="fade-up">Adaptive AI  for Every Industry:</h2>
                        <p className="text-black py-3"  data-aos="fade-up">
                        We provided tailored AI Adaptive services to address the unique challenges and opportunities in your sector. </p>
                    </div>
