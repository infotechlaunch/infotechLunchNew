...
import caseStudyImg from "../assets/Images/case-study.jpeg";
                                   ...
                                   <div className="w-full 2xl:py-40 xl:py-16 py-10">
                                       <div className="space-y-8">
                                           <div>
                                               ...
                                               Real Results, Real Impact — Explore Our Success Stories
                                               </h1>
                                               <p data-aos="fade-right" className="w-full mx-auto text-lg text-white lg:text-base mt-2">
                                               Dive into our case studies to see how we solve real-world problems with smart digital solutions and measurable outcomes.
                                               </p>
                                                </div>
                                       </div>
