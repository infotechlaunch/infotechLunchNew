...
import growthAndMarketingImg from "../assets/Images/growth-and-marketing.jpeg";
...
const GrowthMarketing: React.FC = () => {
    ...
    return (
        <>
            <AOSProvider>
                <HeaderNew />
               <div className="lg:bg-center relative bannerhome bg-no-repeat bg-cover bg-left" style={{
                    backgroundImage: `url(${growthAndMarketingImg})` 
               }}>
                               <div
                                   ...
                                   <div className="w-full 2xl:py-40 xl:py-16 py-10">
                                       <div className="space-y-8">
                                           <div>
                                               ...
                                               Accelerate Your Brand’s Growth With Proven Marketing Strategies
                                               </h1>
                                               <p data-aos="fade-right" className="w-full mx-auto text-lg text-white lg:text-base mt-2">
                                               From SEO to social media, we craft data-driven campaigns that boost visibility, engagement, and conversions for your business.
                                               </p>
                                                </div>
                                       </div>
