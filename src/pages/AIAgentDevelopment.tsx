...
import Services from "../components/AIAgentDevelopment/Services";
import HeaderNew from "../components/Header/HeaderNew";
import WorkingProcess from "../components/AIAgentDevelopment/WorkingProcess";
import WhyChoose from "../components/AIAgentDevelopment/WhyChoose";
import Partners from "../components/Partners/Partners";
import OurPortfolioHome from "../components/AIAgentDevelopment/OurPortfolioHome";
                        ...
                        <div className="space-y-4">
                            <div>
                                <h1 data-aos="fade-right" className="text-white xl:text-4xl text-3xl font-extrabold xl:leading-[3rem] leading-[3rem]  ">
                                    Top-Notch Generative AI Development Service Provider Company</h1>
                                ...
                                <p data-aos="fade-right" className="w-full mx-auto text-sm font-light text-white lg:text-base mt-2">As a leading Generative AI software development company in Jaipur, India, InfoTech Launch harnesses cutting-edge AI technologies to build Generative Artificial intelligence software solutions that drive business innovation. Our expertise in generative artificial intelligence enables us to develop custom Gen AI models, automation tools, and AI-powered applications tailored to your unique business needs.</p>
                                {/* <p data-aos="fade-right" className="w-full mx-auto text-sm font-light text-white lg:text-base mt-2">From Gen AI-driven content creation to predictive analytics and automation, we deliver scalable and future-ready custom generative AI application development solutions that enhance efficiency, boost creativity, and fuel business growth. Partner with us to unlock the full potential of AI in your enterprise business.</p> */}
                            </div>
                        </div>
                ...
                <div className="2xl:w-10/12 w-10/12 lg:w-11/12 mx-auto">
                    <div className="space-y-4 text-center">
                        <div className="flex flex-col justify-center text-center lg:w-4/6 mx-auto">
                            <h2 data-aos="fade-up" className="text-4xl font-bold text-[#212121] text-center leading-[3rem]">We
                                Specialize in a Variety of AI Models – Tailored Gen AI Development Solutions for Every Business Need
                            </h2>
                            <p data-aos="fade-up"> At InfoTech Launch, we pride ourselves on our expertise in developing and
                                deploying a wide range of AI models that cater to specific business requirements. Our team utilizes
                                state-of-the-art algorithms and machine learning techniques to create powerful, custom models that
                                deliver real value and enhance your business operations. We specialize in the following AI models
                            </p>
                        </div>
                        <div className="grid gap-10 pt-8 text-left lg:grid-cols-3 md:grid-cols-2">
                            ...
                            <div data-aos="fade-up" className="border-2 p-8 space-y-2 bg-white border-[#f13c3c]/20 rounded-[40px]">
                                <div data-aos="fade-up"
                                    className="w-20 h-20 bg-[#f13c3c]/10 rounded-[17px] flex justify-center items-center text-[32px] font-semibold text-[#f13c3c]">
                                    04</div>
                                <h3 data-aos="fade-up" className="text-2xl text-[#212121] font-semibold">BERT (Bidirectional Encoder Representations
                                    from Transformers) </h3>
