...
const FoodBeverageeos: React.FC = () => {

    return (
        <>
            <AOSProvider>
                <HeaderNew />
               <div className="lg:bg-center relative bannerhome bg-fd bg-no-repeat bg-cover bg-left">
                               <div
                                   ...
                                   <div className="w-full 2xl:py-40 xl:py-16 py-10">
                                       <div className="space-y-8">
                                           <div>
                                               ...
                                               Fuel Your Food Business With A Complete Technology Solution</h1>
                                               <p data-aos="fade-right" className="w-full mx-auto text-lg text-white lg:text-base mt-2">NFrom Planning To Promoting, Leverage From The Most Advance Food Delivery App Development
                                               Services Backed By Top Industry Expert Consultation At Every Step</p>
                                                </div>
                                       </div>
...
export default FoodBeverageeos;
