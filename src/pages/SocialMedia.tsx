...
import SocialMediaMgmtImg from "../assets/Images/aiSocialMedia/New_AI_PoweredSocialMediaMgmt2-1.png";
import hrlineImg from "../assets/Images/aiSocialMedia/horizon-line.png";
    ...
    return (
        <>
            <AOSProvider>
                ...
                <div className="min-h-screen bg-gradient-blue-red font-sans">
                {/* Content Container with subtle transparency */}
                <div className=" bg-opacity-90 min-h-screen">
                <section className="py-16 px-4 md:px-8 lg:px-16 max-w-7xl mx-auto">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-12 bg-white-rounded">
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between gap-12">
                        ...
                        <div className="relative">
                            ...
                            <div className="relative">
                            {/* AI Block */}
                            <div className="bg-gradient-to-r from-red-500 to-blue-600 w-32 h-32 md:w-40 md:h-40 rounded-xl shadow-lg flex items-center justify-center text-white text-5xl md:text-6xl font-bold transform rotate-6 relative z-20">
                                AI
                            </div>
                            ...
                            <div className="absolute -top-4 left-0 bg-blue-500 w-14 h-14 md:w-16 md:h-16 rounded-full shadow-lg flex items-center justify-center transform rotate-12 z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-x-12 gap-y-10 text-center">
                        {/* Feature 1 */}
                        <div className="p-6 bg-white  rounded-xl hover:shadow-xl transition duration-300">
                        <div className="bg-gradient-to-r from-red-400 to-blue-400 icon-rounded-1" >
                            {/* Clock Icon */}
                        ...
                        <div>
                            ...
                            <p className="text-gray-600">Post at the perfect time, every time</p>
                        </div>
                        </div>
                        ...
                        <div>
                            <h3 className="text-xl font-semibold text-gray-800 mb-2">Multi-Platform Magic</h3>
                            <p className="text-gray-600">Manage all your channels from one sleek dashboard</p>
                        </div>
                        </div>
                        ...
                        <div>
                            <h3 className="text-xl font-semibold text-gray-800 mb-2">Branded Content, At Scale</h3>
                            <p className="text-gray-600">AI crafts posts in your voice</p>
                        </div>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="text-gray-600">See what's working and optimize fast</p>
                        </div>
                        </div>
                    </div>
                    </section>
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between gap-12  bg-white-rounded">
                        ...
                        <div className="md:w-1/2 flex justify-center">
                        <div className="bg-gradient-to-br from-red-100 to-blue-100 rounded-full p-4 w-64 h-64 md:w-72 md:h-72 flex items-center justify-center">
                            <div className="relative w-56 h-56 md:w-64 md:h-64">
                            {/* Stylized people illustration */}
                            <div className="absolute top-2 left-1/2 transform -translate-x-1/2 w-16 h-16 bg-blue-900 rounded-full"></div>
                            <div className="absolute top-10 left-1/4 transform -translate-x-1/2 w-16 h-16 bg-red-400 rounded-full"></div>
                            <div className="absolute top-10 right-1/4 transform translate-x-1/2 w-16 h-16 bg-blue-600 rounded-full"></div>
                            <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 w-16 h-16 bg-pink-300 rounded-full"></div>
                            <div className="absolute bottom-8 right-1/4 transform translate-x-1/2 w-16 h-16 bg-blue-500 rounded-full"></div>
                            <div className="absolute bottom-8 right-1/4 transform translate-x-1/2 w-16 h-16 bg-blue-500 rounded-full"></div>
                            </div>
                        </div>
                        </div>
                    ...
                    {/* CTA Section */}
                    <section className="py-16 px-4 md:px-8 lg:px-16 bg-orange">
                ...
                <div className="bg-gradient-blue-red text-white font-sans">
                    <section className="products-container align-center text-center p-5">
                       <div>
                       <h1 className="workflow-heading workflow-title text-white">🌟 Smarter Social Starts Here</h1>
                        <p className="workflow-subtext text-white">
                        AI-Powered Social Media Management that saves time, boosts <br/>visibility, and drives results—without the hassle.
                        </p>
                        </div>
                        <div>
                        <h2 className="workflow-heading text-white">Automate Your Entire Workflow</h2>
                        <p className="workflow-subtext text-white">
                            From content creation to publishing and performance tracking, our AI <br/>does the heavy lifting. 
                            Focus on strategy. Let automation take care of the rest.
                        </p>
                        </div>
                    </section>
                    <section className="workflow-section bg-gradient-blue-red text-white">                       

                        <h2 className="workflow-heading workflow-title text-white">🚀 What You’ll Love</h2>
                        <div className="hr-section"><img 
                                    src={hrlineImg}
                                    alt="horizon line" 
                                    className="w-full"
                    ...
                    <section className="callout-wrapper bg-gradient-blue-red flex flex-col md:flex-row justify-center items-stretch gap-4 p-6">
                        <div className="callout-card callout-highlight flex-1 bg-white rounded-lg shadow-md p-6">
                            ...
                            <h2 className="callout-heading text-2xl font-semibold mb-2">Who It’s For</h2>
                        ...
                        <div className="callout-card callout-highlight flex-1 bg-white rounded-lg shadow-md p-6">
                            <div className="callout-icon text-4xl mb-4">🎁</div>
                            <h2 className="callout-heading text-2xl font-semibold mb-2">Try It Free – 2 Weeks, On Us</h2>
                            <p className="callout-description text-gray-700">
                    ...
                    <section className="table-wrapper  bg-gradient-blue-red" style={{marginTop: "-50px"}}>
                        <h2 className="table-title text-center text-white">🚀 What Others Don’t Want You to Know</h2>
                        <div className="hr-section"><img 
                                    src={hrlineImg}
                                    alt="horizon line" 
                                    className="w-full"
                    ...
                    <section className="bg-gradient-blue-red py-14 px-6 md:px-20">
                        <div className="itl-section max-w-5xl mx-auto text-center md:text-left">
                            <h2 className="text-3xl md:text-4xl font-bold text-indigo-800 mb-8 flex items-center justify-center gap-3">
                            ...
                            {features.map((feature, index) => (
                                <li key={index} className="flex gap-3" style={{marginLeft: "10%"}}>
                                <span role="img" aria-label="check" style={{ background: "#f3b7b7", padding: "4px 8px", borderRadius: "50%"}}>✅</span>
                                <span>{feature}</span>
                                </li>
                            ))}
                            </ul>
                    ...
                    <section className="bg-gradient-blue-red py-12 px-6">
                        <h2 className="text-3xl font-semibold text-center text-white mb-6">📦 Transparent Pricing – No Hidden Add-Ons</h2>
                        <div className="hr-section"><img 
                                    src={hrlineImg}
                                    alt="horizon line" 
                                    className="w-full"
                        ...
                        {[
                            ...
                            <div key={plan} className="border t-pricing p-4 rounded-lg shadow-sm bg-white text-black">
                            <h3 className="text-2xl font-bold">{plan}</h3>
                            <p className="text-lg mt-2 font-bold text-red">{cost}</p>
